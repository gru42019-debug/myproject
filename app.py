...
# 2. ИНИЦИАЛИЗАЦИЯ НА EASYOCR (Поддържа Български и Английски едновременно)
@st.cache_resource
def load_ocr_reader():
...
# 3. ЕЗИКОВИ ПРЕВОДИ ЗА ИНТЕРФЕЙСА (LOCALIZATION)
LANG_TEXTS = {
    "Български": {
...
# 4. ДВУЕЗИЧНА БАЗА ДАННИ СЪС СТРАНИЧНИ ЕФЕКТИ
HAZARDOUS_INGREDIENTS = {
    # Изкуствени оцветители / Artificial Colors
    "E102": {
    ...
    # Консерванти и овкусители / Preservatives and Enhancers
    "E211": {
    ...
    # Подсладители и мазнини / Sweeteners and Fats
    "E951": {
...
# ДВУЕЗИЧНИ ЗАМЕСТИТЕЛИ / BILINGUAL REPLACEMENTS
...
# 5. СЕЛЕКЦИЯ НА ЕЗИК ОТ СТРАНИЧНОТО МЕНЮ (SIDEBAR)
